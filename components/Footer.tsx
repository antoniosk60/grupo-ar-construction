        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 sm:gap-12 mb-12">
          ...
          <div className="sm:col-span-1">
            ...
            <div className="flex flex-col space-y-3 sm:space-y-4">
              ...
              <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="bg-white/5 hover:bg-blue-500/10 border border-white/10 p-3 sm:p-4 rounded-xl sm:rounded-2xl transition-all flex items-center gap-3 sm:gap-4 group">
