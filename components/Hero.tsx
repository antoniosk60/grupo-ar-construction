      ...
      >
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="hidden lg:block animate-float relative">
            {/* Top Badge */}
            <div className="absolute -top-4 -left-4 z-20 bg-slate-900/90 text-white backdrop-blur-md px-4 py-2 rounded-2xl border border-white/20 shadow-2xl flex items-center gap-2">
            ...
            {/* Bottom Badge */}
            <div className="absolute -bottom-4 -right-4 z-20 bg-amber-500 text-white px-5 py-2.5 rounded-2xl shadow-2xl flex items-center gap-2 border border-amber-400/40">
              <span className="text-xs font-black uppercase tracking-wider font-display">NOM-001-SEDE</span>
              <span className="text-[10px] bg-slate-950/30 px-2 py-0.5 rounded-md font-bold">2012</span>
            </div>

            <div className="relative">
              <div className="absolute -inset-1 bg-gradient-to-r from-amber-500 to-amber-700 rounded-3xl blur opacity-20"></div>
              <div className="relative glass-card p-8 rounded-3xl border border-white/20 shadow-2xl">
