  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (serviceId && templateId && publicKey) {
      try {
        ...
        setErrors({ submit: 'Ocurrió un error al enviar el correo. Por favor, inténtalo de nuevo o contáctanos por WhatsApp.' });
        setStatus('idle');
      }
    } else {
      // Simulate API call or form submission processing if keys are not configured
